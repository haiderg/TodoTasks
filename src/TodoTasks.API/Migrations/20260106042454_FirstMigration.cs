    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#FF5722", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Work related tasks", "Work", null },
                    { 2, "#2196F3", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Personal tasks", "Personal", null },
                    { 3, "#4CAF50", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Shopping list items", "Shopping", null }
                });

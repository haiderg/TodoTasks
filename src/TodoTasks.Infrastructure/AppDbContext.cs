...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>().HasData(
            new { Id = 1, Name = "Work", Description = "Work related tasks", Color = TaskColorEnum.Yellow, CreatedAt = new DateTime(2024, 1, 1) },
            new { Id = 2, Name = "Personal", Description = "Personal tasks", Color = TaskColorEnum.Red, CreatedAt = new DateTime(2024, 1, 1) },
            new { Id = 3, Name = "Shopping", Description = "Shopping list items", Color = TaskColorEnum.Green, CreatedAt = new DateTime(2024, 1, 1) }
        );
